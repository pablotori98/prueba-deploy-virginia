...
export const BannerInfoSpanish = () => {
  return (
    <Box>
    <Box className="bannerinfo">
      ...
      <Box className="rightbanner">
        <p className="infopsico">
          Spanish lorem Ipsum is simply dummy text of the printing and typesetting
